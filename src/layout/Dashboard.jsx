    ...
    return (
        ...
        <div className='md:flex md:min-h-screen'>
            <div className='md:w-1/5 bg-gray-800 px-5 py-4'>
                ...
                <img src="https://st3.depositphotos.com/19428878/37089/v/450/depositphotos_370895286-stock-illustration-default-avatar-profile-icon-vector.jpg" alt="img-client" className="m-auto mt-8 p-1 border-2 border-slate-500 rounded-full" width={120} height={120} />
            ...
            <div className='flex-1 flex flex-col justify-between h-screen bg-gray-100'>
                <div className='bg-gray-800 py-2 flex md:justify-end items-center gap-5 justify-center'>
                    ...
                    <div>
                        ...
                        <img src="https://st3.depositphotos.com/19428878/37089/v/450/depositphotos_370895286-stock-illustration-default-avatar-profile-icon-vector.jpg" alt="img-client" className="border-2 border-green-600 rounded-full" width={50} height={50} />
                    </div>
                    <div>
